...
%Pak # 182213
f=@(x,y)4*y-4*x; %Here we input our function such that dy/dx = f(x,y)
...
h=input('\n The step size h: '); %example h=0.1
 fprintf('\n x        y '); % creating the heading for table contaning values of x and y
while x0<=xn %The loop will repeat until the final value of x is reached
    fprintf('\n%4.3f  %4.3f ',x0,y0); %values of x0 and y0
